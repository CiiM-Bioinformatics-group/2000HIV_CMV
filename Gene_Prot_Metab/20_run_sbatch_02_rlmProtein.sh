#!/bin/bash
#SBATCH --job-name=rlm_protein       # Name of job
#SBATCH --output=scripts/rlm_protein.out        # stdout
#SBATCH --error=scripts/rlm_protein.err         # stderr
...
Rscript 05_proteinAnalysis_01_rlmModel.R
