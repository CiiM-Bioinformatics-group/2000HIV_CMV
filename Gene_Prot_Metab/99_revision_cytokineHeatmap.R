...
load("dat/rlmRes_cytokine.RData") # to get the sig. cytokines
...
load("dat/rlmRes_cytokine_forHeatmap.RData") # to get the effect size for all cytokine production
...
# save the plot ------------------------------------------------------------------
png("reAnalysis_outcome/cytokine/10_cytokine_heatmap.png",height = 1008)
heatmap_plot
dev.off()
