#!/bin/bash
#SBATCH --job-name=rlm_mebo       # Name of job
#SBATCH --output=scripts/rlm_mebo.out        # stdout
#SBATCH --error=scripts/rlm_mebo.err         # stderr
...
Rscript 06_meboAnalysis_01_rlmModel.R
